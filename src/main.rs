...
#[cfg_attr(feature = "naive", path = "composition_naive.rs")]
#[cfg_attr(feature = "cooperman_ma", path = "composition_cooperman_ma.rs")]
mod composition_naive;

use composition_naive::{permutation_composition, PermT};
